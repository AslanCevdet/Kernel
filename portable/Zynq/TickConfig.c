...
const uint8_t ucRisingEdge = 3;
	...
	XScuGic_SetPriTrigTypeByDistAddr(INTC_DIST_BASE_ADDR, XPAR_SCUTIMER_INTR, ((configMAX_API_CALL_INTERRUPT_PRIORITY + 1) << 3), ucRisingEdge);
	XScuGic_RegisterHandler( INTC_BASE_ADDR, XPAR_SCUTIMER_INTR, ( Xil_ExceptionHandler )FreeRTOS_Tick_Handler,( void * ) &xTimer);
	...
	XScuGic_EnableIntr (INTC_DIST_BASE_ADDR, XPAR_SCUTIMER_INTR);
